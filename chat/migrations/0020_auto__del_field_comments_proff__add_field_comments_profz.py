...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Comments.proff'
        db.delete_column(u'chat_comments', 'proff_id')

        # Adding field 'Comments.profz'
        db.add_column(u'chat_comments', 'profz',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chat.UserProfile'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Comments.proff'
        db.add_column(u'chat_comments', 'proff',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['chat.UserProfile']),
                      keep_default=False)

        # Deleting field 'Comments.profz'
        db.delete_column(u'chat_comments', 'profz_id')
    ...
    models = {
        ...
        u'chat.comments': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'profz': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['chat.UserProfile']", 'null': 'True', 'blank': 'True'}),
