...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'chat_userprofile', (
            ...
            ('primRole', self.gf('django.db.models.fields.CharField')(max_length=20, blank=True)),
            ('secRole', self.gf('django.db.models.fields.CharField')(max_length=20, blank=True)),
            ('tier', self.gf('django.db.models.fields.CharField')(max_length=20, blank=True)),
            ('division', self.gf('django.db.models.fields.IntegerField')(blank=True)),
        ))
    ...
    models = {
        ...
        u'chat.userprofile': {
            ...
            'division': ('django.db.models.fields.IntegerField', [], {'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ign': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '75'}),
            'isMod': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'primRole': ('django.db.models.fields.CharField', [], {'max_length': '20', 'blank': 'True'}),
            'secRole': ('django.db.models.fields.CharField', [], {'max_length': '20', 'blank': 'True'}),
