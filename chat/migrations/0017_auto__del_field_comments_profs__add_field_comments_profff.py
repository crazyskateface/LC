...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Comments.profs'
        db.delete_column(u'chat_comments', 'profs_id')

        # Adding field 'Comments.profff'
        db.add_column(u'chat_comments', 'profff',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chat.UserProfile'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Comments.profs'
        db.add_column(u'chat_comments', 'profs',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=False, to=orm['chat.UserProfile']),
                      keep_default=False)

        # Deleting field 'Comments.profff'
        db.delete_column(u'chat_comments', 'profff_id')
    ...
    models = {
        ...
        u'chat.comments': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'profff': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['chat.UserProfile']", 'null': 'True'}),
